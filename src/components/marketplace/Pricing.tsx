  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-card/90 backdrop-blur-xl rounded-2xl border border-border/60 shadow-xl overflow-hidden">
          <div className="px-4 sm:px-6 py-3 border-b border-border/60 bg-muted/60 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            <div className="text-left">
              <p className="text-xs sm:text-sm font-semibold text-emerald-500 uppercase tracking-wide">
            ...
            <div className="inline-flex items-center gap-2 rounded-full bg-emerald-500/10 px-3 py-1 border border-emerald-500/40">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full text-left text-sm">
              <thead>
                <tr className="bg-card/95 text-foreground">
              ...
              <tbody className="divide-y divide-border/60">
                <tr>
                  <td className="px-4 sm:px-6 py-4 align-top">
                    <p className="font-semibold text-foreground">7–8 vs 7–8</p>
                    <p className="mt-1 text-xs text-foreground/75 sm:hidden">
                  ...
                  <td className="px-4 sm:px-6 py-4 align-top text-right">
                    <p className="text-sm font-semibold text-foreground">{formatCopValor(60000)}</p>
                    <p className="mt-1 text-[11px] uppercase tracking-wide text-emerald-400 font-semibold">
                      Por partido
                    </p>
                  </td>
                  <td className="px-4 sm:px-6 py-4 align-top text-right">
                    ...
                    <p className="mt-1 text-[11px] uppercase tracking-wide text-foreground/70 font-semibold">
                      14–16 jugadores
                    </p>
                  </td>
                </tr>
                ...
                <tr className="bg-background/60">
                  <td className="px-4 sm:px-6 py-4 align-top">
                    <p className="font-semibold text-foreground">9–10 vs 9–10</p>
                    <p className="mt-1 text-xs text-foreground/75 sm:hidden">
                  ...
                  <td className="px-4 sm:px-6 py-4 align-top text-right">
                    <p className="text-sm font-semibold text-foreground">{formatCopValor(80000)}</p>
                    <p className="mt-1 text-[11px] uppercase tracking-wide text-emerald-400 font-semibold">
                      Por partido
                    </p>
                  </td>
                ...
                <tr>
                  <td className="px-4 sm:px-6 py-4 align-top">
                    <p className="font-semibold text-foreground">11 vs 11 (Central)</p>
                    <p className="mt-1 text-xs text-foreground/75 sm:hidden">Fútbol 11 completo</p>
                  </td>
                  <td className="px-4 sm:px-6 py-4 align-top hidden sm:table-cell">
                    <p className="text-xs text-foreground/75">
                  ...
                  <td className="px-4 sm:px-6 py-4 align-top text-right">
                    <p className="text-sm font-semibold text-foreground">{formatCopValor(90000)}</p>
                    <p className="mt-1 text-[11px] uppercase tracking-wide text-emerald-400 font-semibold">
                      Por partido
                    </p>
                  </td>
                ...
                <tr className="bg-background/60">
                  ...
                  <td className="px-4 sm:px-6 py-4 align-top text-right">
                    <p className="text-sm font-semibold text-foreground">{formatCopValor(180000)}</p>
                    <p className="mt-1 text-[11px] uppercase tracking-wide text-emerald-400 font-semibold">
                      Por partido
                    </p>
                  </td>
          ...
          <div className="px-4 sm:px-6 py-3 bg-card/95 border-t border-border/60 text-[11px] sm:text-xs text-foreground/80 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1.5">
            <p>
