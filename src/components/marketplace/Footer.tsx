...
export function Footer() {
  ...
  return (
    <footer id="contacto" className="py-12 sm:py-16 bg-gradient-to-b from-background via-primary/30 to-primary relative overflow-hidden scroll-mt-20">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="sm:hidden text-center space-y-8">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col items-center gap-2 text-sm text-foreground/80">
              <a href={`mailto:contacto@${APP_NAME.toLowerCase()}.com`} className="flex items-center gap-2 hover:text-foreground transition-colors">
                <Mail className="w-4 h-4" />
                contacto@{APP_NAME.toLowerCase()}.com
              </a>
              <a href="tel:+573001234567" className="flex items-center gap-2 hover:text-foreground transition-colors">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap justify-center gap-4 text-sm text-foreground/80">
              <button onClick={() => handleScrollTo("#arbitros-destacados")} className="hover:text-foreground transition-colors">
                Árbitros
              </button>
              <button onClick={() => handleScrollTo("#como-funciona")} className="hover:text-foreground transition-colors">
                Cómo Funciona
              </button>
              <button onClick={() => handleScrollTo("#contacto")} className="hover:text-foreground transition-colors">
                Contacto
              </button>
            </div>
          </div>
          ...
          <div className="pt-6 border-t border-foreground/20">
            <p className="text-xs text-foreground/60">© 2026 {APP_NAME}. Todos los derechos reservados.</p>
          </div>
        </div>
        ...
        <div className="hidden sm:block">
          ...
          <div className="pt-8 border-t border-foreground/20 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-sm text-foreground/70">© 2026 {APP_NAME}. Todos los derechos reservados.</p>
