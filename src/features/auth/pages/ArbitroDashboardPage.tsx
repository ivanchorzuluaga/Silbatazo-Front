    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background p-4 safe-area-inset">
      ...
      <div className="w-full max-w-md space-y-6 rounded-lg border bg-card p-4 sm:p-6 shadow-sm">
        <div className="space-y-2 text-center">
          <h1 className="text-xl sm:text-2xl font-bold">Dashboard - Árbitro</h1>
          <p className="text-sm sm:text-base text-muted-foreground">
            Bienvenido, {user?.username || "Árbitro"}
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          {/* Funcionalidades para árbitros */}
          <div className="space-y-2 rounded-md border bg-muted/30 p-4">
            <h2 className="text-sm font-semibold mb-2">Funcionalidades</h2>
            <p className="text-sm text-muted-foreground">
              Aquí podrás gestionar tu disponibilidad, aceptar/rechazar partidos, ver tus ganancias y retiros.
            </p>
            <p className="text-xs text-muted-foreground mt-2 italic">
              (Próximamente en Fase 2-4)
            </p>
          </div>
