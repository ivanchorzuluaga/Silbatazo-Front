        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex-1 min-w-0">
              <div className="flex flex-wrap items-center gap-2 mb-3">
                ...
                <Badge variant={partido.estado === "aceptado" ? "success" : partido.estado === "completado" ? "default" : "warning"}>
                {partido.estado_display}
                </Badge>
              {partido.estado_pago && (
                  <Badge variant={partido.estado_pago === "aprobado" ? "success" : "warning"} size="sm">
