...
export function PerfilArbitroForm({
  ...
  useEffect(() => {
    ...
    const target =
      focusSection === "personal" ? personalRef.current : experienciaRef.current;
    if (!target) return;
    setTimeout(() => {
                  ...
                  <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
                    {categoriasPartido.map((categoria) => (
                      ...
                      >
                        ...
                        <span className="min-w-0 text-foreground">{categoria.nombre}</span>
                      </label>
                    ))}
                  </div>
                )}
                  ...
                  <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
                    {roles.map((rol) => (
                      ...
                      >
                        ...
                        <span className="min-w-0 text-foreground">{rol.nombre}</span>
                      </label>
                    ))}
                  </div>
                )}
